...
func TestCloseTaskSummaryModal_ImplementsModal(t *testing.T) {
	var _ Modal = NewCloseTaskSummaryModal(task.CloseTaskResult{}, 80, 24)
}

func TestCloseTaskSummaryModal_ViewShowsStepsStatusIconsAndOverall(t *testing.T) {
	m := NewCloseTaskSummaryModal(task.CloseTaskResult{
		TaskID: "IN-900",
...
func TestCloseTaskSummaryModal_OverallSuccess(t *testing.T) {
	m := NewCloseTaskSummaryModal(task.CloseTaskResult{TaskID: "IN-901", Success: true}, 80, 24)
	view := stripAnsi(m.View())
...
func TestCloseTaskSummaryModal_EnterOrEscClose(t *testing.T) {
	m := NewCloseTaskSummaryModal(task.CloseTaskResult{}, 80, 24)
